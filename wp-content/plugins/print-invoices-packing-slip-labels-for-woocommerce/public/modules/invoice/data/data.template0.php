...
.wfte_product_table_head th{ height:36px; padding:0px 5px; font-size:.75rem; text-align:start; line-height:10px; border-bottom:solid 1px #D7DBDF; font-family:"Helvetica Neue", Roboto, Arial, "Droid Sans", sans-serif;}
    ...
    <div class="wfte_row clearfix">
        <div class="wfte_col-3 float_left">
            ...
            <div class="wfte_invoice_data">
                <div class="wfte_tel wfte_template_element" data-hover-id="tel">
                    <span class="wfte_tel_label wfte_order_fields_label">__[Phone no:]__ </span>
        ...
        <div class="wfte_col-3 float_right">
            <div class="wfte_invoice_data">
                ...
                <div class="wfte_email wfte_template_element wfte_hidden" data-hover-id="email">
                    <span class="wfte_email_label wfte_order_fields_label">__[Email:]__</span>
