...
class Wps_Rma_Refund_Request_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->description = 'Customer to Admin Side Refund Request Emails and vice versa<h1>These are shorcodes available for the custom email</h1><br><span>' . apply_filters( 'wps_rma_refund_shortcode', $shortcodes ) . '</span></b>';
		...
		$this->template_html  = 'wps-rma-refund-request-email-template.php';
		$this->template_plain = 'wps-rma-refund-request-email-template.php';
	...
	public function get_default_heading() {
		return esc_html__( 'Refund Request Email', 'woo-refund-and-exchange-lite' );
	}
